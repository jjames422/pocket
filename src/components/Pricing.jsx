...
export function Pricing() {
  ...
  return (
    <section
      ...
      className="border-t border-violet-700 bg-slate-900 py-20 sm:py-32"
    >
      <Container>
        <div className="mx-auto max-w-2xl text-center">
          <h2
            id="pricing-title"
            className="text-3xl font-medium tracking-tight text-violet-700"
          >
        ...
        <div className="mt-8 flex justify-center">
          <div className="relative">
            ...
            <div
              aria-hidden="true"
              className={clsx(
                'pointer-events-none absolute inset-0 z-10 grid grid-cols-2 overflow-hidden rounded-lg bg-violet-700 transition-all duration-300',
                activePeriod === 'Monthly'
