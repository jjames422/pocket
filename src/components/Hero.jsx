    ...
    <div {...props}>
      ...
      >
        ...
        <defs>
          ...
          >
            <stop stopColor="#6fccdd" />
            <stop offset="1" stopColor="#6fccdd" stopOpacity="0" />
          </linearGradient>
        </defs>
      </svg>
      <svg
...
export function Hero() {
  return (
    <div className="overflow-hidden py-20 sm:py-32 lg:pb-32 xl:pb-36 bg-slate-900">
      <Container>
        <div className="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-20">
          <div className="relative z-10 mx-auto max-w-2xl lg:col-span-7 lg:max-w-none lg:pt-6 xl:col-span-6">
            <h1 className="text-4xl font-medium tracking-tight text-violet-700">
                Zero in on your it.
            </h1>
